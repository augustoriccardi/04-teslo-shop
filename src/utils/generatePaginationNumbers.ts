...
export const generatePaginationNumbers = (
  ...
  // monstrar las primeras 3, puntos suspensivos, y las ;últimas 2
  if (currentPage <= 3) {
    return [1, 2, 3, "...", totalPages - 1, totalPages];
  } //[1,2,3,'...',49,50]

  // Si la página actual está entre las últimas 3 páginas
  // mostrar las primeras dos, puntos suspensivos, las últimas 3 páginas
  if (currentPage >= totalPages - 2) {
    return [1, 2, "...", totalPages - 2, totalPages - 1, totalPages]; // [1,2,"...",49, 50]
  }

  // Si la página acutal está en otro lugar medio
